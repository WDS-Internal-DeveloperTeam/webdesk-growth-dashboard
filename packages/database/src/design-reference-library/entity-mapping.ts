 ...
 *  (`content-template-library/entity-mapping.ts`, `brand-library/entity-mapping.ts`, etc.) — no
 *  shared cross-module version exists in this codebase, by established precedent. Includes
 *  `publishedAt` alongside the usual `createdAt`/`updatedAt`, mirroring Brand Library's own
 *  identical helper. */
