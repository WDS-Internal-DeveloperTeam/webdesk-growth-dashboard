 ...
 *  (`case-study-studio/entity-mapping.ts`, `persona-library/entity-mapping.ts`, etc.) — no shared
 *  cross-module version exists in this codebase, by established precedent. */
