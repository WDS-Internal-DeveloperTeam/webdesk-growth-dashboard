...
export function getAuditModels(sequelize: Sequelize = getConnection()): AuditModels {
  ...
  const AuditEvent = sequelize.define(
    "AuditEvent",
    {
      ...
      eventCategory: { type: DataTypes.STRING(32), allowNull: false },
      ...
      sourceApplication: { type: DataTypes.STRING(64), allowNull: false },
      environment: { type: DataTypes.STRING(32), allowNull: false },
      confidentialityClassification: { type: DataTypes.STRING(32), allowNull: false },
