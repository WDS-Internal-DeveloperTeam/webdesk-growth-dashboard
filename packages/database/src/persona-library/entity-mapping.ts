 ...
 *  (`service-library/entity-mapping.ts`, `business-knowledge/entity-mapping.ts`,
 *  `projects/entity-mapping.ts`, etc.) — no shared cross-module version exists in this codebase,
