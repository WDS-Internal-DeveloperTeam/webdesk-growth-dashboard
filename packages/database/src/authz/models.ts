...
export function getAuthzModels(sequelize: Sequelize = getConnection()): AuthzModels {
  ...
  const ModuleRegistry = sequelize.define(
    "ModuleRegistry",
    {
      ...
      navigationGroup: { type: DataTypes.STRING(64), allowNull: false },
      navigationOrder: { type: DataTypes.INTEGER, allowNull: false },
      route: { type: DataTypes.STRING(255), allowNull: false, unique: true },
      iconReference: { type: DataTypes.STRING(64), allowNull: true },
      v1InclusionStatus: {
      ...
      viewPermissionAction: { type: DataTypes.STRING(64), allowNull: false },
      actionPermissions: { type: DataTypes.JSONB, allowNull: true },
      featureStatus: { type: DataTypes.STRING(128), allowNull: true },
      documentationReference: { type: DataTypes.STRING(255), allowNull: true },
      helpDocumentReference: { type: DataTypes.STRING(255), allowNull: true },
      owner: { type: DataTypes.STRING(128), allowNull: true },
      dependencies: { type: DataTypes.JSONB, allowNull: true },
      confidentialityLevel: { type: DataTypes.TEXT, allowNull: true },
      badgeSupport: { type: DataTypes.BOOLEAN, allowNull: false },
      visibilityRules: { type: DataTypes.JSONB, allowNull: true },
      deprecationReference: { type: DataTypes.STRING(255), allowNull: true },
      registryVersion: { type: DataTypes.INTEGER, allowNull: false },
