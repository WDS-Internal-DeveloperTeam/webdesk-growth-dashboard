 ...
 *  (`content-template-library/entity-mapping.ts`, `persona-library/entity-mapping.ts`,
 ...
 *  `createdAt`/`updatedAt`, mirroring Content Template Library's own identical helper. */
