import type { ScanFindingEntity, ScanFindingRepository } from "@webdesk/database";
...
describe("ScanFindingsService", () => {
  ...
  let svc: ScanFindingsService;

  beforeEach(() => {
    repo = { findById: vi.fn(), list: vi.fn(), updateStatus: vi.fn() };
    authorizationService = { assertAllowed: vi.fn() };
    auditService = { record: vi.fn() };
    svc = new ScanFindingsService(
      repo as unknown as ScanFindingRepository,
