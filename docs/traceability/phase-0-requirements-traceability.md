...
| REQ-003 | `01_...md` — PostgreSQL + Sequelize                               | 0/1B  | packages/database                                   | Architect, DBA | —                                                      | ADR-0006, 0007       | database               | Migration test                           | G-Schema    | Architecture Defined    | Provider confirmed 2026-08-07 (Supabase, us-east-1) — see `docs/project-state/setup-input-register.md`. Task package prepared (`docs/task-packages/phase-1b-database-foundation.md`), execution not yet authorized. |
